  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <p className="text-xl text-slate-500 dark:text-slate-400">Loading category...</p>
      </div>
    )
  }
    ...
    <div className="relative">
      ...
      >
        <div className="flex flex-col gap-4 items-center">
          <Link
            href="/categories"
            className="px-4 py-2 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white border border-white/20 hover:border-white/40 transition-all duration-300"
          >
            ← All Categories
          </Link>
